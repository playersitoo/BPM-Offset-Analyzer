🎵 BPM & Offset Analyzer
A modular audio analysis tool designed to assist osu! mappers and other rhythm game creators in accurately detecting BPM and adjusting offsets automatically.

🚀 Project Architecture
The project is built using a decoupled architecture to separate analytical logic from the user interface:
...
App/
│
├── core/               # Audio analysis logic and internationalization (i18n)
│   ├── analyzer.py     # Core timing and BPM calculation algorithm
│   └── i18n.py         # Multi-language support
│
├── ui/                 # Graphical interface components
│   └── app.py          # Initial test views
│
├── main.py             # Main entry point for the Python engine
└── requirements.txt    # Project dependencies
⚙️ Requirements & Installation (Alpha Phase)
...
[x] Base structure for the Python analysis engine.
